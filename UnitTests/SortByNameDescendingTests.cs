...
namespace UnitTests
{
    public class SortByNameDescendingTests
    {
        ...
        [Test]
        public async Task OnGetAsync_SortsByNameDescending()
        {
            ...
            Assert.AreEqual("Charlie Brown", accounts[0].User.Name);
            Assert.AreEqual("Bob Jones", accounts[1].User.Name);
            Assert.AreEqual("Alice Smith", accounts[2].User.Name);
        }
