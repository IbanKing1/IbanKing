    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicedPayments", x => x.ServicedPaymentId);
                    table.ForeignKey(
                        name: "FK_ServicedPayments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_ServicedPayments_ServicedPaymentId",
                        column: x => x.ServicedPaymentId,
                        principalTable: "ServicedPayments",
                        principalColumn: "ServicedPaymentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicedPayments_UserId",
                table: "ServicedPayments",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ServicedPaymentId",
                table: "Transactions",
                column: "ServicedPaymentId");
